...
from ecom.views import GoogleLoginView,GoogleLoginCallbackView

from ecom.views import recommendation_view
...
urlpatterns = [
    ...
    path('customer_login/', GoogleLoginView.as_view(), name='customer_login'),
    path('customer_login/callback/', GoogleLoginCallbackView.as_view(), name='customer_login_callback'),
    ...
    path('recommended_products/', views.recommendation_view, name='recommended_products'),
    path('customer_home/recommended_products/', views.recommendation_view, name='recommended_products'),
